...
- In Samsung Internet: Menu → "Add page to" → "Home screen"`);
  ...
  return (
    <Card className="fixed bottom-20 left-4 right-4 z-50 border-2 border-green-200 bg-white shadow-lg">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-sm">
          Install Nandi Coffee Advisory on your phone for faster access and offline features
        </CardDescription>
      </CardHeader>
